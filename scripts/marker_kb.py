...
pub = rospy.Publisher('ar_tag/cmd_vel', Twist, queue_size=10)
...
while not rospy.is_shutdown():
    ...
    vel_msg.linear.x = (controllmap[1] - controllmap[3]) * speed
    vel_msg.linear.y = (controllmap[0] - controllmap[2]) * speed
